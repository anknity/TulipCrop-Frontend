...
const ProductCategories = () => {
  return (
    <section className="py-24 px-6 lg:px-8 bg-transparent overflow-hidden" id="categories">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map((category, index) => (
            ...
            >
              <Link
                to="/products"
                className="group relative overflow-hidden rounded-2xl aspect-[4/3] border border-white/10 hover:border-brand-lime/40 transition-all duration-500 hover:-translate-y-1 block h-full"
              >
                ...
                <div className="relative z-10 h-full p-8 flex flex-col justify-end">
                  <div className="mb-auto">
                    <div className="w-12 h-12 rounded-xl bg-white/10 border border-white/20 backdrop-blur-md flex items-center justify-center text-white mb-6">
                    {category.icon}
                  </div>
                </div>
                <div>
